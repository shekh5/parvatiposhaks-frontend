            ...
            <div className="form-content">
                <form className="form" onSubmit={forgotSubmit}>
                    ...
                    <div className="input-group">
                        <input type="email" name='email' placeholder="Email" required className="form-input" value={loginEmail} onChange={(e) => setLoginEmail(e.target.value)} />
                    </div>
                    <button className="authBtn">{loading?'Sending':'Send'}</button>
                    <p className="form-links">
                        login?<Link to="/user/login" className="form-link">login</Link>
                    </p>
                    <p className="form-links">
