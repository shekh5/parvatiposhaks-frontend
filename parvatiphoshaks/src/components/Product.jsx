    ...
    return (<>
        <Link to={`product/${product._id}`} className="product_id">
            <div className="product-card">
                <img src={product.Image?.[0]?.url || 'placeholder.jpg'} alt={product.name} className="product-image-card" />
                <div className="product-details">
                    ...
                    <span className="productCardSpan">{product.noOfreviews}{product.numoFreviews === 1 ? " Review" : " Reviews"}</span>
